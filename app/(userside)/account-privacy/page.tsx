    ...
    return (
        <div className="min-h-screen p-6 bg-[#fcfcfc] flex flex-col  ">
            ...
            <div className="w-full flex-1  flex flex-col lg:flex-row gap-8">
                ...
                <div className="block lg:hidden">
                    <Sidebar active="privacy" open={sidebarOpen} onClose={() => setSidebarOpen(false)} />
                </div>
                {/* Main Content */}
                <div className="flex-1 bg-white rounded-2xl border shadow-xl p-8 flex flex-col">
                    <h2 className="text-2xl  mb-8">Privacy Policy</h2>
...
<div className="flex">
    ...
    <div className="flex flex-col flex-1 gap-2">
        ...
        <p className="text-[16px] font-normal">Privacy Center</p>
        <p className="text-[14px] font-light">Take control of your privacy and learn how we protect it.</p>
    </div>
